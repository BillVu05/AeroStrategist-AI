...
class RevenueModel:
    ...
    def monthly_revenue(
        ...
        """`route_override` lets a caller price a route that is not in the
        airline profile - a proposed new destination - on exactly this
        revenue model. It needs only `distance_km` and `assigned_aircraft`."""
