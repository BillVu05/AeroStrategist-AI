...
The original roadmap allowed Market/Risk agents real web/news context via LLM +
...
(pacific_wings/agents/context.py). This is documented honestly in docs/agent_architecture.md
