...
Thin orchestration wrapper around the Phase 8 LangGraph (pacific_wings/agents/graph.py):
...
produced entirely by SimulationEngine and never touched by the LLM.
"""

from pacific_wings.agents.graph import build_graph
