...
that already feeds the demand model (pacific_wings/ml/features.py) - this module just
...
from pacific_wings.analysis.open_route import _currency_risk, _geo_risk
...
# (pacific_wings/ml/train.py) - same for every destination (one global
