...
the deterministic simulation engine (Phases 3-7, `pacific_wings/simulation/engine.py`) and
...
from pacific_wings.agents.llm_client import DEFAULT_MODEL, UNAVAILABLE_NOTICE, get_client
