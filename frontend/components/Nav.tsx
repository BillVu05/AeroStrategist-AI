...
const LINKS = [
  ...
  { href: "/routes",       label: "Route Explorer",  icon: "map"       },
  { href: "/market",       label: "Market & Demand", icon: "insights"  },
  { href: "/scenario-lab", label: "Scenario Lab",    icon: "science"   },
  { href: "/copilot",      label: "AI Copilot",      icon: "smart_toy" },
  { href: "/reports",      label: "Report Library",  icon: "analytics" },
];
